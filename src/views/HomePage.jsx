...
const services = [
  ...
  { icon: '🐧', title: 'Linux VPS Hosting', desc: 'Managed Linux VPS servers optimized for Node.js, Next.js, and modern frameworks. Root access with full management included — from R12,000/mo.', to: '/vps' },
