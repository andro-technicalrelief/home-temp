...
export default function RegisterPage() {
  const [form, setForm] = useState({
    ...
    businessName: '', website: '', address1: '', city: '', state: '', postalCode: '', country: 'ZA',
      ...
      <div className="relative z-10 w-full max-w-[520px]">
        ...
        <div className="bg-[var(--color-bg-card)] border border-[var(--color-border-dark)] rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="businessName" className="block text-sm font-medium text-[var(--color-text-light)] mb-2">Company Name (Optional)</label>
                <input id="businessName" type="text" value={form.businessName} onChange={update('businessName')} className={inputClass} placeholder="Acme Corp" />
              </div>
              <div>
                <label htmlFor="website" className="block text-sm font-medium text-[var(--color-text-light)] mb-2">Website (Optional)</label>
                <input id="website" type="url" value={form.website} onChange={update('website')} className={inputClass} placeholder="https://example.com" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <label htmlFor="postalCode" className="block text-sm font-medium text-[var(--color-text-light)] mb-2">Postal Code</label>
                <input id="postalCode" type="text" value={form.postalCode} onChange={update('postalCode')} className={inputClass} placeholder="8001" />
              </div>
            </div>
